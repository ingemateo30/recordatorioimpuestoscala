...
manana.setDate(hoy.getDate() + 1);
  ...
  const mailOptions = {
    ...
    to: destino,
    subject: asunto,
    bcc: 'mateo.s3009@gmail.com , johana@calaasociados.com , mayra@calaasociados.com , nancy@calaasociados.com , meortizz96@gmail.com , sjulianac15@gmail.com , dm25814@gmail.com , contabilidad@calaasociados.com , jimmy@calaasociados.com',
    attachments: [{
      filename: 'cala.png',
      path: './public/cala.png',
      cid: 'company-logo'
